...
export default (props) => {
    ...
    const getStyles = (index) => {
        if (activeSlide === index)
            ...
            return {
                opacity: 1,
                transform: "translateX(-460px) translateZ(-400px) ",
                zIndex: 9,
            ...
            return {
                opacity: 1,
                transform: "translateX(-750px) translateZ(-500px) ",
                zIndex: 8
            };
        else if (activeSlide + 2 === index)
            return {
    ...
    return (
        <div className="slider_js">
                ...
                <div className="slideC">
                    ...
                    {activeSlide == 0 ? (
                        ...
                        >
                            ...
                            <div className="floating-text">{"IMG" + String(10)}</div>
                            <SliderContent {...(props.data[9])} />
                        </div>
            ...
            <div className="btns flex_div arrow_btns">
                <FontAwesomeIcon
                    className="btn"
                    onClick={prev}
                    icon={faArrowLeft}
